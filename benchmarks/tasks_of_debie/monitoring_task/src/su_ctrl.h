...
extern unsigned short int ReadDelayCounters_FromPlasma1Minus;
extern unsigned short int ReadDelayCounters (delays_t EXTERNAL delay);
...
/* Trigger levels */
extern trigger_set_t SetTriggerLevel_result;
extern unsigned int SetTriggerLevel_base;
extern unsigned char SetTriggerLevel(trigger_set_t EXTERNAL setting)
