...
unsigned int Read_AD_Channel_unsigned_ADC = 0;
signed int Read_AD_Channel_signed_ADC = 0;
unsigned char Read_AD_Channel (ADC_parameters_t EXTERNAL ADC_results);
...
uint_least8_t UpdatePeriodCounter(uint_least8_t EXTERNAL counter, 
                         uint_least8_t full_counter_value); 
extern signed int Convert_AD_signed_ADC;
extern unsigned int Convert_AD_unsigned_ADC;
unsigned char Convert_AD (ADC_parameters_t EXTERNAL ADC_parameters);
...
{   
   ...
   trigger = SetTriggerLevel_result;
 
   trigger.level   = settings.plasma_1_minus_threshold;
   trigger.channel = PLASMA_1_MINUS;
   SetTriggerLevel (trigger);    trigger = SetTriggerLevel_result;
...

{
   ...
   DIRECT_INTERNAL unsigned int i, j;
   /* Loop variable */
   ...
   execution_result = SetSensorUnitOff(su1_e, execution_result);
   /* Set Sensor Unit 1 to Off state */

   execution_result = SetSensorUnitOff(su2_e, execution_result);
   /* Set Sensor Unit 2 to Off state */

   execution_result = SetSensorUnitOff(su3_e, execution_result);
   /* Set Sensor Unit 3 to Off state */

   execution_result = SetSensorUnitOff(su4_e, execution_result);
   ...
   { 
      ...
      for (i=0; i < sizeof(telemetry_data); i++)
      {
          ...
          ANNOT_MAXITER(120);
#else
#error sizeof(telemetry_data_t) dependent bound.
#error Check the Check_Type_Size function in your target assembly. 
#endif
         ((unsigned char *)(&telemetry_data))[i] = 0;
/*
         fill_pointer = 0;
         fill_pointer++;
*/
...
/*
      telemetry_data.error_status = 0;
      telemetry_data.mode_status = 0;               
      telemetry_data.TC_word = 0;                  
      telemetry_data.TC_time_tag = 0;             
      telemetry_data.watchdog_failures = 0;
      telemetry_data.checksum_failures= 0;
      telemetry_data.SW_version= 0;
      telemetry_data.isr_send_message_error= 0;

      telemetry_data.SU_status[0]= 0;
      telemetry_data.SU_status[1]= 0;
      telemetry_data.SU_status[2]= 0;
      telemetry_data.SU_status[3]= 0;
      telemetry_data.SU_hits[0] = 0;
      telemetry_data.SU_hits[1] = 0;
      telemetry_data.SU_hits[2] = 0;
      telemetry_data.SU_hits[3] = 0;
      telemetry_data.SU_temperature[0][0] = 0;
      telemetry_data.SU_temperature[1][1] = 0;
      telemetry_data.SU_temperature[2][0] = 0;
      telemetry_data.SU_temperature[3][1] = 0;
      telemetry_data.SU_temperature[0][0] = 0;
      telemetry_data.SU_temperature[1][1] = 0;
      telemetry_data.SU_temperature[2][0] = 0;
      telemetry_data.SU_temperature[3][1] = 0;
      telemetry_data.DPU_plus_5_digital= 0;
      telemetry_data.os_send_message_error= 0;
      telemetry_data.os_create_task_error= 0;
      telemetry_data.SU_plus_50= 0;
      telemetry_data.SU_minus_50= 0;
      telemetry_data.os_disable_isr_error= 0;
      telemetry_data.not_used_1= 0;

      telemetry_data.sensor_unit_1.plus_5_voltage = 0;
      telemetry_data.sensor_unit_1.minus_5_voltage = 0;
      telemetry_data.sensor_unit_1.plasma_1_plus_threshold = 0;
      telemetry_data.sensor_unit_1.plasma_1_minus_threshold = 0;
      telemetry_data.sensor_unit_1.piezo_threshold = 0;
      telemetry_data.sensor_unit_1.plasma_1_plus_classification = 0;
      telemetry_data.sensor_unit_1.plasma_1_minus_classification = 0;
      telemetry_data.sensor_unit_1.piezo_1_classification = 0;
      telemetry_data.sensor_unit_1.piezo_2_classification = 0;
      telemetry_data.sensor_unit_1.plasma_2_plus_classification = 0;
      telemetry_data.sensor_unit_1.plasma_1_plus_to_minus_max_time = 0;
      telemetry_data.sensor_unit_1.plasma_1_plus_to_piezo_min_time = 0;
      telemetry_data.sensor_unit_1.plasma_1_plus_to_piezo_max_time = 0;
      telemetry_data.sensor_unit_1.plasma_1_minus_to_piezo_min_time = 0;
      telemetry_data.sensor_unit_1.plasma_1_minus_to_piezo_max_time = 0;

      telemetry_data.sensor_unit_2.plus_5_voltage = 0;
      telemetry_data.sensor_unit_2.minus_5_voltage = 0;
      telemetry_data.sensor_unit_2.plasma_1_plus_threshold = 0;
      telemetry_data.sensor_unit_2.plasma_1_minus_threshold = 0;
      telemetry_data.sensor_unit_2.piezo_threshold = 0;
      telemetry_data.sensor_unit_2.plasma_1_plus_classification = 0;
      telemetry_data.sensor_unit_2.plasma_1_minus_classification = 0;
      telemetry_data.sensor_unit_2.piezo_1_classification = 0;
      telemetry_data.sensor_unit_2.piezo_2_classification = 0;
      telemetry_data.sensor_unit_2.plasma_2_plus_classification = 0;
      telemetry_data.sensor_unit_2.plasma_1_plus_to_minus_max_time = 0;
      telemetry_data.sensor_unit_2.plasma_1_plus_to_piezo_min_time = 0;
      telemetry_data.sensor_unit_2.plasma_1_plus_to_piezo_max_time = 0;
      telemetry_data.sensor_unit_2.plasma_1_minus_to_piezo_min_time = 0;
      telemetry_data.sensor_unit_2.plasma_1_minus_to_piezo_max_time = 0;

      telemetry_data.sensor_unit_3.plus_5_voltage = 0;
      telemetry_data.sensor_unit_3.minus_5_voltage = 0;
      telemetry_data.sensor_unit_3.plasma_1_plus_threshold = 0;
      telemetry_data.sensor_unit_3.plasma_1_minus_threshold = 0;
      telemetry_data.sensor_unit_3.piezo_threshold = 0;
      telemetry_data.sensor_unit_3.plasma_1_plus_classification = 0;
      telemetry_data.sensor_unit_3.plasma_1_minus_classification = 0;
      telemetry_data.sensor_unit_3.piezo_1_classification = 0;
      telemetry_data.sensor_unit_3.piezo_2_classification = 0;
      telemetry_data.sensor_unit_3.plasma_2_plus_classification = 0;
      telemetry_data.sensor_unit_3.plasma_1_plus_to_minus_max_time = 0;
      telemetry_data.sensor_unit_3.plasma_1_plus_to_piezo_min_time = 0;
      telemetry_data.sensor_unit_3.plasma_1_plus_to_piezo_max_time = 0;
      telemetry_data.sensor_unit_3.plasma_1_minus_to_piezo_min_time = 0;
      telemetry_data.sensor_unit_3.plasma_1_minus_to_piezo_max_time = 0;

      telemetry_data.sensor_unit_4.plus_5_voltage = 0;
      telemetry_data.sensor_unit_4.minus_5_voltage = 0;
      telemetry_data.sensor_unit_4.plasma_1_plus_threshold = 0;
      telemetry_data.sensor_unit_4.plasma_1_minus_threshold = 0;
      telemetry_data.sensor_unit_4.piezo_threshold = 0;
      telemetry_data.sensor_unit_4.plasma_1_plus_classification = 0;
      telemetry_data.sensor_unit_4.plasma_1_minus_classification = 0;
      telemetry_data.sensor_unit_4.piezo_1_classification = 0;
      telemetry_data.sensor_unit_4.piezo_2_classification = 0;
      telemetry_data.sensor_unit_4.plasma_2_plus_classification = 0;
      telemetry_data.sensor_unit_4.plasma_1_plus_to_minus_max_time = 0;
      telemetry_data.sensor_unit_4.plasma_1_plus_to_piezo_min_time = 0;
      telemetry_data.sensor_unit_4.plasma_1_plus_to_piezo_max_time = 0;
      telemetry_data.sensor_unit_4.plasma_1_minus_to_piezo_min_time = 0;
      telemetry_data.sensor_unit_4.plasma_1_minus_to_piezo_max_time = 0;

      telemetry_data.failed_code_address = 0;    
      telemetry_data.failed_data_address = 0;   
      telemetry_data.os_wait_error= 0;
      telemetry_data.os_attach_interrupt_error= 0;
      telemetry_data.os_enable_isr_error= 0;
      telemetry_data.time= 0;
      telemetry_data.software_error= 0;
      telemetry_data.hit_budget_exceedings= 0;
      telemetry_data.coefficient[0]= 0;
      telemetry_data.coefficient[1]= 0;
      telemetry_data.coefficient[2]= 0;
      telemetry_data.coefficient[3]= 0;
      telemetry_data.coefficient[4]= 0;
      telemetry_data.not_used= 0;
*/
      /* End inlined init. */
...
#warning Neverending loop commented.
/*   
    while(1)
   {
        ANNOT_MAXITER(1);
...
/*                                            V = 18*M = 180 secs            */
{
   ...
   if (health_mon_round == round_0_e)
   {
    ...
    else if (health_mon_round == round_1_e) {
      // case round_1_e:
    ...
    else if (health_mon_round == round_2_e) {
      //case round_2_e:                                   
    ...
    else if (health_mon_round == round_3_e) {
      //case round_3_e:
    ...
    else if (health_mon_round == round_4_e) {
      //case round_4_e:
    ...
    else if (health_mon_round == round_5_e) {
      //case round_5_e:
    ...
    else if (health_mon_round == round_6_e) {
      //case round_6_e:
    ...
    else if (health_mon_round == round_7_e) {
      //case round_7_e:
    ...
    else if (health_mon_round == round_8_e) {
      //case round_8_e:
    ...
    else if (health_mon_round == round_9_e) {
      //case round_9_e:
...
/*                    function is called.                                    */
{
...

   {
      ...
      Read_AD_Channel_unsigned_ADC = AD_temperature_parameters.unsigned_ADC;
      Read_AD_Channel_signed_ADC = AD_temperature_parameters.signed_ADC;
      AD_temperature_parameters.AD_execution_result = Read_AD_Channel(AD_temperature_parameters);
      AD_temperature_parameters.unsigned_ADC = Read_AD_Channel_unsigned_ADC;
      AD_temperature_parameters.signed_ADC = Read_AD_Channel_signed_ADC;
...
/*                    mode Status Register are set.                          */
{
...

   {
...

      {
         ...
         exec_result = SetSensorUnitOff(i,exec_result);
...
/*                       in telemetry_data.                                  */
{
   ...
   Read_AD_Channel_signed_ADC = AD_voltage_parameters.signed_ADC;
   Read_AD_Channel_unsigned_ADC = AD_voltage_parameters.unsigned_ADC;
   AD_voltage_parameters.AD_execution_result = Read_AD_Channel(AD_voltage_parameters);
   AD_voltage_parameters.signed_ADC = Read_AD_Channel_signed_ADC;
   AD_voltage_parameters.unsigned_ADC = Read_AD_Channel_unsigned_ADC;
   ...
   else
   {
      ...
      if (channel_0_e == channel_selector)
      {
    ...
    else if (channel_1_e == channel_selector) {
         //case channel_1_e:
    ...
    else if (channel_2_e == channel_selector) {
         //case channel_2_e:
    ...
    else if (channel_3_e == channel_selector) {
         //case channel_3_e:
    ...
    else if (channel_4_e == channel_selector) {
         //case channel_4_e:
    ...
    else if (channel_5_e == channel_selector) {
         //case channel_5_e:
    ...
    else if (channel_6_e == channel_selector) {
...
#warning Function pointers have been commented.
}	
...
uint_least8_t UpdatePeriodCounter(
...
ADC_parameters_t Convert_AD_result;
unsigned char Convert_AD (ADC_parameters_t EXTERNAL ADC_parameters)
...
/*                    indication of this occurred anomaly.                   */
{
   ...
   Convert_AD_result = ADC_parameters;
...
/*                       SU_Status register.                                 */
{
   ...
   exec_result = SetSensorUnitOff(SU_index,exec_result);
   /* Switch off given sensor unit. */    
...
/*                  for at least the desired duration.                       */
{
   ...
   {
       //duration is never bigger than 919
       ANNOT_MAXITER(3);
...
unsigned char Read_AD_Channel (ADC_parameters_t EXTERNAL ADC_parameters)
...
/*                  End of loop                                              */
{
   ...
   while (tries_left > 0)
   {
      ...
      ADC_parameters = Convert_AD_result;
   ...
   Read_AD_Channel_unsigned_ADC = ADC_parameters.unsigned_ADC;
   Read_AD_Channel_signed_ADC = ADC_parameters.signed_ADC;
   return ADC_parameters.AD_execution_result;
}
...
/*                       register.                                           */
{
   ...
   Read_AD_Channel_unsigned_ADC = ADC_test_parameters.unsigned_ADC;
   Read_AD_Channel_signed_ADC = ADC_test_parameters.signed_ADC;
   ADC_test_parameters.AD_execution_result = Read_AD_Channel(ADC_test_parameters);
   ADC_test_parameters.unsigned_ADC = Read_AD_Channel_unsigned_ADC;
   ADC_test_parameters.signed_ADC = Read_AD_Channel_signed_ADC;
...
/*                    corresponding error bit is set.                        */
{
   ...
   if (self_test_SU_index == su1_e || self_test_SU_index == su2_e)
   {
      /*case su1_e:
      case su2_e:*/
    ...
    else if (self_test_SU_index == su3_e || self_test_SU_index == su4_e) {
         /*break;
...
/*                    to ON.                                                 */
{
   ...
   SetTriggerLevel (test_threshold);    test_threshold = SetTriggerLevel_result;
...
{
   SU_settings_t EXTERNAL PROGRAM setting_map_c[4];
   
   setting_map_c[0] = telemetry_data.sensor_unit_1;
   setting_map_c[1] = telemetry_data.sensor_unit_2;
   setting_map_c[2] = telemetry_data.sensor_unit_3;
   setting_map_c[3] = telemetry_data.sensor_unit_4;
   ...
   threshold.channel = PLASMA_1_PLUS;
      SetTriggerLevel (threshold);       threshold = SetTriggerLevel_result;
   ...
   Switch_SU_State_result = SU_switch;
   Switch_SU_State(SU_switch);
   SU_switch = Switch_SU_State_result;
