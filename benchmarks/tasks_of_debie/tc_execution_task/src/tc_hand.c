...

{
   ...
   else
   {
      ...
      if (ALL_INVALID == TC_look_up[TC_address])
      {
         //case ALL_INVALID:
         /* Invalid TC Address */
      ...
      else if (ALL_VALID == TC_look_up[TC_address]) {
      ...
      else if (ONLY_EQUAL == TC_look_up[TC_address]) {
         //case ONLY_EQUAL:
      ...
      else if (ON_OFF_TC == TC_look_up[TC_address]) {
         //case ON_OFF_TC:
      ...
      else if (ONLY_EVEN == TC_look_up[TC_address]) {
         //case ONLY_EVEN:
   ...
   if (TC_address == SEND_STATUS_REGISTER)
   {
      ...
      WRITE_TM_MSB (*((unsigned char *)&telemetry_data + TC_code));
      telemetry_pointer++;
      WRITE_TM_LSB (*((unsigned char *)&telemetry_data + 1 + TC_code));
      telemetry_pointer++;
   ...
   else if (TC_address == SEND_SCIENCE_DATA_FILE)
   {
      ...
      else  
      {
         ...
         WRITE_TM_MSB (*((unsigned char *)&science_data + 1));
         telemetry_pointer++;
         WRITE_TM_LSB (*((unsigned char *)&science_data + 1));
         telemetry_pointer++;
...
/*                          set Threshold according to "command"             */
{
   ...
   if (SET_COEFFICIENT_1 == command.TC_address ||
       SET_COEFFICIENT_2 == command.TC_address ||
       SET_COEFFICIENT_3 == command.TC_address ||
       SET_COEFFICIENT_4 == command.TC_address ||
       SET_COEFFICIENT_5 == command.TC_address)
   {
       /*
    ...
    else if (SET_SU_1_PLASMA_1E_1I_MAX_TIME == command.TC_address ||
             SET_SU_2_PLASMA_1E_1I_MAX_TIME == command.TC_address ||
             SET_SU_3_PLASMA_1E_1I_MAX_TIME == command.TC_address ||
             SET_SU_4_PLASMA_1E_1I_MAX_TIME == command.TC_address)
    {
        /*
      ...
      */
         ...
         if (SU_index == 0)
             telemetry_data.sensor_unit_1.plasma_1_plus_to_minus_max_time =
                command.TC_code;
         else if (SU_index == 1)
             telemetry_data.sensor_unit_2.plasma_1_plus_to_minus_max_time =
                command.TC_code;
         else if (SU_index == 2)
             telemetry_data.sensor_unit_3.plasma_1_plus_to_minus_max_time =
                command.TC_code;
         else if (SU_index == 3)
             telemetry_data.sensor_unit_4.plasma_1_plus_to_minus_max_time =
                command.TC_code;
    ...
    else if (SET_SU_1_PLASMA_1E_PZT_MIN_TIME == command.TC_address ||
             SET_SU_2_PLASMA_1E_PZT_MIN_TIME == command.TC_address ||
             SET_SU_3_PLASMA_1E_PZT_MIN_TIME == command.TC_address ||
             SET_SU_4_PLASMA_1E_PZT_MIN_TIME == command.TC_address)
    {
        /*
      ...
      */
         ...
         if (SU_index == 0)
             telemetry_data.sensor_unit_1.plasma_1_plus_to_piezo_min_time =
                command.TC_code;
         else if (SU_index == 1)
             telemetry_data.sensor_unit_2.plasma_1_plus_to_piezo_min_time =
                command.TC_code;
         else if (SU_index == 2)
             telemetry_data.sensor_unit_3.plasma_1_plus_to_piezo_min_time =
                command.TC_code;
         else if (SU_index == 3)
             telemetry_data.sensor_unit_4.plasma_1_plus_to_piezo_min_time =
                command.TC_code;
    ...
    else if (SET_SU_1_PLASMA_1E_PZT_MAX_TIME == command.TC_address ||
             SET_SU_2_PLASMA_1E_PZT_MAX_TIME == command.TC_address ||
             SET_SU_3_PLASMA_1E_PZT_MAX_TIME == command.TC_address ||
             SET_SU_4_PLASMA_1E_PZT_MAX_TIME == command.TC_address)
    {
        /*
      ...
      */
         ...
         if (SU_index == 0)
             telemetry_data.sensor_unit_1.plasma_1_plus_to_piezo_max_time =
                command.TC_code;
         else if (SU_index == 1)
             telemetry_data.sensor_unit_2.plasma_1_plus_to_piezo_max_time =
                command.TC_code;
         else if (SU_index == 2)
             telemetry_data.sensor_unit_3.plasma_1_plus_to_piezo_max_time =
                command.TC_code;
         else if (SU_index == 3)
             telemetry_data.sensor_unit_4.plasma_1_plus_to_piezo_max_time =
                command.TC_code;
          //SU_config[SU_index] -> plasma_1_plus_to_piezo_max_time =
          //   command.TC_code;
          //break;
    }
    else if (SET_SU_1_PLASMA_1I_PZT_MIN_TIME == command.TC_address ||
             SET_SU_2_PLASMA_1I_PZT_MIN_TIME == command.TC_address ||
             SET_SU_3_PLASMA_1I_PZT_MIN_TIME == command.TC_address ||
             SET_SU_4_PLASMA_1I_PZT_MIN_TIME == command.TC_address)
    {
      ...
      */
         ...
         if (SU_index == 0)
             telemetry_data.sensor_unit_1.plasma_1_minus_to_piezo_min_time =
                command.TC_code;
         else if (SU_index == 1)
             telemetry_data.sensor_unit_2.plasma_1_minus_to_piezo_min_time =
                command.TC_code;
         else if (SU_index == 2)
             telemetry_data.sensor_unit_3.plasma_1_minus_to_piezo_min_time =
                command.TC_code;
         else if (SU_index == 3)
             telemetry_data.sensor_unit_4.plasma_1_minus_to_piezo_min_time =
                command.TC_code;
          //SU_config[SU_index] -> plasma_1_minus_to_piezo_min_time =
          //   command.TC_code;
          //break;
    }
    else if (SET_SU_1_PLASMA_1I_PZT_MAX_TIME == command.TC_address ||
             SET_SU_2_PLASMA_1I_PZT_MAX_TIME == command.TC_address ||
             SET_SU_3_PLASMA_1I_PZT_MAX_TIME == command.TC_address ||
             SET_SU_4_PLASMA_1I_PZT_MAX_TIME == command.TC_address)
    {
      ...
      */
         ...
         if (SU_index == 0)
             telemetry_data.sensor_unit_1.plasma_1_minus_to_piezo_max_time =
                command.TC_code;
         else if (SU_index == 1)
             telemetry_data.sensor_unit_2.plasma_1_minus_to_piezo_max_time =
                command.TC_code;
         else if (SU_index == 2)
             telemetry_data.sensor_unit_3.plasma_1_minus_to_piezo_max_time =
                command.TC_code;
         else if (SU_index == 3)
             telemetry_data.sensor_unit_4.plasma_1_minus_to_piezo_max_time =
                command.TC_code;
          // SU_config[SU_index] -> plasma_1_minus_to_piezo_max_time =
          //   command.TC_code;
          //break;
    }
    else if (SET_SU_1_PLASMA_1P_CLASS_LEVEL == command.TC_address ||
             SET_SU_2_PLASMA_1P_CLASS_LEVEL == command.TC_address ||
             SET_SU_3_PLASMA_1P_CLASS_LEVEL == command.TC_address ||
             SET_SU_4_PLASMA_1P_CLASS_LEVEL == command.TC_address)
    {
      ...
      */
         ...
         if (SU_index == 0)
             telemetry_data.sensor_unit_1.plasma_1_plus_classification =
                command.TC_code;
         else if (SU_index == 1)
             telemetry_data.sensor_unit_2.plasma_1_plus_classification =
                command.TC_code;
         else if (SU_index == 2)
             telemetry_data.sensor_unit_3.plasma_1_plus_classification =
                command.TC_code;
         else if (SU_index == 3)
             telemetry_data.sensor_unit_4.plasma_1_plus_classification =
                command.TC_code;
         //SU_config[SU_index] -> plasma_1_plus_classification = 
         //   command.TC_code;
         //break;
    }
    else if (SET_SU_1_PLASMA_1M_CLASS_LEVEL == command.TC_address ||
             SET_SU_2_PLASMA_1M_CLASS_LEVEL == command.TC_address ||
             SET_SU_3_PLASMA_1M_CLASS_LEVEL == command.TC_address ||
             SET_SU_4_PLASMA_1M_CLASS_LEVEL == command.TC_address)
    {
        /*
      ...
      */
         ...
         if (SU_index == 0)
             telemetry_data.sensor_unit_1.plasma_1_minus_classification =
                command.TC_code;
         else if (SU_index == 1)
             telemetry_data.sensor_unit_2.plasma_1_minus_classification =
                command.TC_code;
         else if (SU_index == 2)
             telemetry_data.sensor_unit_3.plasma_1_minus_classification =
                command.TC_code;
         else if (SU_index == 3)
             telemetry_data.sensor_unit_4.plasma_1_minus_classification =
                command.TC_code;
         //SU_config[SU_index] -> plasma_1_minus_classification = 
         //   command.TC_code;
         //break;
    }
    else if (SET_SU_1_PLASMA_2P_CLASS_LEVEL == command.TC_address ||
             SET_SU_2_PLASMA_2P_CLASS_LEVEL == command.TC_address ||
             SET_SU_3_PLASMA_2P_CLASS_LEVEL == command.TC_address ||
             SET_SU_4_PLASMA_2P_CLASS_LEVEL == command.TC_address)
    {
        /*
      ...
      */
         ...
         if (SU_index == 0)
             telemetry_data.sensor_unit_1.plasma_2_plus_classification =
                command.TC_code;
         else if (SU_index == 1)
             telemetry_data.sensor_unit_2.plasma_2_plus_classification =
                command.TC_code;
         else if (SU_index == 2)
             telemetry_data.sensor_unit_3.plasma_2_plus_classification =
                command.TC_code;
         else if (SU_index == 3)
             telemetry_data.sensor_unit_4.plasma_2_plus_classification =
                command.TC_code;
         //SU_config[SU_index] -> plasma_2_plus_classification = 
         //   command.TC_code;
         //break;
    }
    else if (SET_SU_1_PIEZO_1_CLASS_LEVEL == command.TC_address ||
             SET_SU_2_PIEZO_1_CLASS_LEVEL == command.TC_address ||
             SET_SU_3_PIEZO_1_CLASS_LEVEL == command.TC_address ||
             SET_SU_4_PIEZO_1_CLASS_LEVEL == command.TC_address)
    {
        /*
      ...
      */
         ...
         if (SU_index == 0)
             telemetry_data.sensor_unit_1.piezo_1_classification =
                command.TC_code;
         else if (SU_index == 1)
             telemetry_data.sensor_unit_2.piezo_1_classification =
                command.TC_code;
         else if (SU_index == 2)
             telemetry_data.sensor_unit_3.piezo_1_classification =
                command.TC_code;
         else if (SU_index == 3)
             telemetry_data.sensor_unit_4.piezo_1_classification =
                command.TC_code;
         //SU_config[SU_index] -> piezo_1_classification = 
         //   command.TC_code;
         //break;
    }
    else if (SET_SU_1_PIEZO_2_CLASS_LEVEL == command.TC_address ||
             SET_SU_2_PIEZO_2_CLASS_LEVEL == command.TC_address ||
             SET_SU_3_PIEZO_2_CLASS_LEVEL == command.TC_address ||
             SET_SU_4_PIEZO_2_CLASS_LEVEL == command.TC_address)
    {
        /*
      ...
      */
         ...
         if (SU_index == 0)
             telemetry_data.sensor_unit_1.piezo_2_classification =
                command.TC_code;
         else if (SU_index == 1)
             telemetry_data.sensor_unit_2.piezo_2_classification =
                command.TC_code;
         else if (SU_index == 2)
             telemetry_data.sensor_unit_3.piezo_2_classification =
                command.TC_code;
         else if (SU_index == 3)
             telemetry_data.sensor_unit_4.piezo_2_classification =
                command.TC_code;
         //SU_config[SU_index] -> piezo_2_classification = 
         //   command.TC_code;
         //break;
    }
    else if (ERROR_STATUS_CLEAR == command.TC_address)
    {
    ...
    else if (SET_TIME_BYTE_3 == command.TC_address)
    {
    ...
    else if (SET_TIME_BYTE_2 == command.TC_address)
    {
    ...
    else if (SET_TIME_BYTE_1 == command.TC_address)
    {
    ...
    else if (SET_TIME_BYTE_0 == command.TC_address)
    {
    ...
    else if (CLEAR_WATCHDOG_FAILURES == command.TC_address)
    {
    ...
    else if (CLEAR_CHECKSUM_FAILURES == command.TC_address)
    {
    ...
    else if (SWITCH_SU_1 == command.TC_address ||
             SWITCH_SU_2 == command.TC_address ||
             SWITCH_SU_3 == command.TC_address ||
             SWITCH_SU_4 == command.TC_address)
    {
      ...
      */
         ...
         if (GetMode() != ACQUISITION)
         {
            ...
            if (ON_VALUE == command.TC_code)
            {
               //case ON_VALUE:
                  SU_setting.execution_result = Start_SU_SwitchingOn(SU_index,
                     (SU_setting.execution_result));
                  //break;
            }
            else if (OFF_VALUE == command.TC_code)
            {

               //case OFF_VALUE:
                  SU_setting.execution_result = SetSensorUnitOff(SU_index, (SU_setting.execution_result));
                  //break;
            }
            else if (SELF_TEST == command.TC_code)
            {

               //case SELF_TEST:
                  SU_setting.SU_state              = self_test_mon_e;
                  SU_setting.expected_source_state = on_e;
                  Switch_SU_State_result = SU_setting;
                  Switch_SU_State (SU_setting);
                  SU_setting = Switch_SU_State_result;
                  //break;
            }
    ...
    else if (SET_SU_1_PLASMA_1P_THRESHOLD == command.TC_address)
    {
      //case SET_SU_1_PLASMA_1P_THRESHOLD:
         ...
         SetTriggerLevel (new_threshold);          new_threshold = SetTriggerLevel_result;

         telemetry_data.sensor_unit_1.plasma_1_plus_threshold = 
            command.TC_code;
         //break;
    }
    else if (SET_SU_2_PLASMA_1P_THRESHOLD == command.TC_address)
    {
    ...
    else if (SET_SU_3_PLASMA_1P_THRESHOLD == command.TC_address)
    {
    ...
    else if (SET_SU_4_PLASMA_1P_THRESHOLD == command.TC_address)
    {
    ...
    else if (SET_SU_1_PLASMA_1M_THRESHOLD == command.TC_address)
    {
    ...
    else if (SET_SU_2_PLASMA_1M_THRESHOLD == command.TC_address)
    {
    ...
    else if (SET_SU_3_PLASMA_1M_THRESHOLD == command.TC_address)
    {
    ...
    else if (SET_SU_4_PLASMA_1M_THRESHOLD == command.TC_address)
    {
    ...
    else if (SET_SU_1_PIEZO_THRESHOLD == command.TC_address)
    {
    ...
    else if (SET_SU_2_PIEZO_THRESHOLD == command.TC_address)
    {
    ...
    else if (SET_SU_3_PIEZO_THRESHOLD == command.TC_address)
    {
    ...
    else if (SET_SU_4_PIEZO_THRESHOLD == command.TC_address)
    {
...

{
   ...
   /* switch (command -> TC_address) */
   if (READ_DATA_MEMORY_MSB == command.TC_address)
   {
      /*
   ...
   else if (WRITE_CODE_MEMORY_MSB == command.TC_address)
   {
   ...
   else if (WRITE_DATA_MEMORY_MSB == command.TC_address)
   {
    ...
    else if (WRITE_CODE_MEMORY_LSB == command.TC_address ||
             WRITE_DATA_MEMORY_LSB == command.TC_address)
    {
    ...
    else if (SOFT_RESET == command.TC_address)
    {
    ...
    else if (START_ACQUISITION == command.TC_address)
    {
    ...
    else if (STOP_ACQUISITION == command.TC_address)
    {
...

{
   ...
   WaitMail_execution_result = TC_mail.execution_result;
   WaitMail_wait_result = TC_mail.wait_result;
   received_command.TC_word = WaitMail(TC_mail);
   TC_mail.wait_result = WaitMail_wait_result;
   TC_mail.execution_result = WaitMail_execution_result;
...
#warning Neverending loop commented.
   ...
   while(1)
   {
      //Unused function, meaningless loop bound
      ANNOT_MAXITER(2);
      HandleTelecommand ();
   }
  */ 
