...
unsigned char CalculateQualityNumber(event_record_t EXTERNAL new_event)
...

{
   ...
   return new_event.quality_number;
}

unsigned char ClassifyEvent_Result_quality_number = 0;
unsigned char ClassifyEvent(event_record_t EXTERNAL new_event)
...

{
   ...
   /* Select proper classification thresholds. */
   {
    ...
    if (SU_state[new_event.SU_number - SU_1] == self_test_e)
    {
       ...
       ClassifyEvent_Result_quality_number = MAX_QUALITY;
    }

    else
    {
       new_event.quality_number = CalculateQualityNumber(new_event);
       ClassifyEvent_Result_quality_number = CalculateQualityNumber(new_event);
    }

    return new_event.classification;
}
...

{
   ...
   telemetry_data.sensor_unit_1.plasma_1_plus_threshold       = DEFAULT_THRESHOLD;
   telemetry_data.sensor_unit_1.plasma_1_minus_threshold      = DEFAULT_THRESHOLD;
   telemetry_data.sensor_unit_1.piezo_threshold               = DEFAULT_THRESHOLD;
   telemetry_data.sensor_unit_1.plasma_1_plus_classification  = DEFAULT_CLASSIFICATION_LEVEL;
   telemetry_data.sensor_unit_1.plasma_1_minus_classification = DEFAULT_CLASSIFICATION_LEVEL;
   telemetry_data.sensor_unit_1.piezo_1_classification        = DEFAULT_CLASSIFICATION_LEVEL;
   telemetry_data.sensor_unit_1.piezo_2_classification        = DEFAULT_CLASSIFICATION_LEVEL;
   telemetry_data.sensor_unit_1.plasma_2_plus_classification  = DEFAULT_CLASSIFICATION_LEVEL;
   telemetry_data.sensor_unit_1.plasma_1_plus_to_minus_max_time  = DEFAULT_MAX_TIME;
   telemetry_data.sensor_unit_1.plasma_1_plus_to_piezo_min_time  = DEFAULT_MIN_TIME;
   telemetry_data.sensor_unit_1.plasma_1_plus_to_piezo_max_time  = DEFAULT_MAX_TIME;
   telemetry_data.sensor_unit_1.plasma_1_minus_to_piezo_min_time = DEFAULT_MIN_TIME;
   telemetry_data.sensor_unit_1.plasma_1_minus_to_piezo_max_time = DEFAULT_MAX_TIME;
   /* Default values for thresholds, classification levels and min/max times */
   /* related to classification are set here.                                */
   
   telemetry_data.sensor_unit_2.plasma_1_plus_threshold       = DEFAULT_THRESHOLD;
   telemetry_data.sensor_unit_2.plasma_1_minus_threshold      = DEFAULT_THRESHOLD;
   telemetry_data.sensor_unit_2.piezo_threshold               = DEFAULT_THRESHOLD;
   telemetry_data.sensor_unit_2.plasma_1_plus_classification  = DEFAULT_CLASSIFICATION_LEVEL;
   telemetry_data.sensor_unit_2.plasma_1_minus_classification = DEFAULT_CLASSIFICATION_LEVEL;
   telemetry_data.sensor_unit_2.piezo_1_classification        = DEFAULT_CLASSIFICATION_LEVEL;
   telemetry_data.sensor_unit_2.piezo_2_classification        = DEFAULT_CLASSIFICATION_LEVEL;
   telemetry_data.sensor_unit_2.plasma_2_plus_classification  = DEFAULT_CLASSIFICATION_LEVEL;
   telemetry_data.sensor_unit_2.plasma_1_plus_to_minus_max_time  = DEFAULT_MAX_TIME;
   telemetry_data.sensor_unit_2.plasma_1_plus_to_piezo_min_time  = DEFAULT_MIN_TIME;
   telemetry_data.sensor_unit_2.plasma_1_plus_to_piezo_max_time  = DEFAULT_MAX_TIME;
   telemetry_data.sensor_unit_2.plasma_1_minus_to_piezo_min_time = DEFAULT_MIN_TIME;
   telemetry_data.sensor_unit_2.plasma_1_minus_to_piezo_max_time = DEFAULT_MAX_TIME;

   telemetry_data.sensor_unit_3.plasma_1_plus_threshold       = DEFAULT_THRESHOLD;
   telemetry_data.sensor_unit_3.plasma_1_minus_threshold      = DEFAULT_THRESHOLD;
   telemetry_data.sensor_unit_3.piezo_threshold               = DEFAULT_THRESHOLD;
   telemetry_data.sensor_unit_3.plasma_1_plus_classification  = DEFAULT_CLASSIFICATION_LEVEL;
   telemetry_data.sensor_unit_3.plasma_1_minus_classification = DEFAULT_CLASSIFICATION_LEVEL;
   telemetry_data.sensor_unit_3.piezo_1_classification        = DEFAULT_CLASSIFICATION_LEVEL;
   telemetry_data.sensor_unit_3.piezo_2_classification        = DEFAULT_CLASSIFICATION_LEVEL;
   telemetry_data.sensor_unit_3.plasma_2_plus_classification  = DEFAULT_CLASSIFICATION_LEVEL;
   telemetry_data.sensor_unit_3.plasma_1_plus_to_minus_max_time  = DEFAULT_MAX_TIME;
   telemetry_data.sensor_unit_3.plasma_1_plus_to_piezo_min_time  = DEFAULT_MIN_TIME;
   telemetry_data.sensor_unit_3.plasma_1_plus_to_piezo_max_time  = DEFAULT_MAX_TIME;
   telemetry_data.sensor_unit_3.plasma_1_minus_to_piezo_min_time = DEFAULT_MIN_TIME;
   telemetry_data.sensor_unit_3.plasma_1_minus_to_piezo_max_time = DEFAULT_MAX_TIME;

   telemetry_data.sensor_unit_4.plasma_1_plus_threshold       = DEFAULT_THRESHOLD;
   telemetry_data.sensor_unit_4.plasma_1_minus_threshold      = DEFAULT_THRESHOLD;
   telemetry_data.sensor_unit_4.piezo_threshold               = DEFAULT_THRESHOLD;
   telemetry_data.sensor_unit_4.plasma_1_plus_classification  = DEFAULT_CLASSIFICATION_LEVEL;
   telemetry_data.sensor_unit_4.plasma_1_minus_classification = DEFAULT_CLASSIFICATION_LEVEL;
   telemetry_data.sensor_unit_4.piezo_1_classification        = DEFAULT_CLASSIFICATION_LEVEL;
   telemetry_data.sensor_unit_4.piezo_2_classification        = DEFAULT_CLASSIFICATION_LEVEL;
   telemetry_data.sensor_unit_4.plasma_2_plus_classification  = DEFAULT_CLASSIFICATION_LEVEL;
   telemetry_data.sensor_unit_4.plasma_1_plus_to_minus_max_time  = DEFAULT_MAX_TIME;
   telemetry_data.sensor_unit_4.plasma_1_plus_to_piezo_min_time  = DEFAULT_MIN_TIME;
   telemetry_data.sensor_unit_4.plasma_1_plus_to_piezo_max_time  = DEFAULT_MAX_TIME;
   telemetry_data.sensor_unit_4.plasma_1_minus_to_piezo_min_time = DEFAULT_MIN_TIME;
   telemetry_data.sensor_unit_4.plasma_1_minus_to_piezo_max_time = DEFAULT_MAX_TIME;
}
