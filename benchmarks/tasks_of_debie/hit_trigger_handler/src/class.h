...
extern unsigned char ClassifyEvent_Result_quality_number;
extern event_record_t event_queue[];
extern unsigned char ClassifyEvent(event_record_t EXTERNAL new_event);
