...
#ifndef MSP430PIPELINEANALYSIS_H
#define MSP430PIPELINEANALYSIS_H

class MSP430PipelineAnalysis:public PipelineAnalysis
{
 ...
 public:
  ...
  /** Constructor */
  MSP430PipelineAnalysis (Program * p, int nbcache);
