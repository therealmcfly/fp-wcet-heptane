...
/*****************************************************************
                             MSP430AddressAnalysis

This is the entry point of the dataflow analysis of 
data and stack addresses for MSP430 architecture.
...
#ifndef MSP430ADDRESSANALYSIS_H
#define MSP430ADDRESSANALYSIS_H
...
class MSP430AddressAnalysis:public AddressAnalysis
{
 ...
 public:
  ...
  /** Constructor */
  MSP430AddressAnalysis (Program * p, int sp);
