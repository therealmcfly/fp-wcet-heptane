...
class Solver
{
  ...
  */
  ...
  /** Generate constraint varid equal to 0 */
  virtual void generate_null_variable(ostringstream & os,string varid) =0;
  ...
  virtual void generate_inequality (ostringstream & os, vector < string > vid, int N) = 0;
   ...
   /** Generate a integer to binary variable conversion: if X > 0 then q=1 else q=0*/
  virtual void generate_int2bin(ostringstream & os, const string &X, const string &q) = 0;
...
class LpsolveSolver:public Solver
{
 public:
  ...
  void generate_null_variable(ostringstream & os,string varid);
  ...
  void generate_int2bin(ostringstream & os, const string &X, const string &q);
