...
#define CHMCAttributeNameCode(l) string(CHMCAttributeName)+"L" +to_string(l) + "Code"
#define CHMCAttributeNameData(l) string(CHMCAttributeName)+"L" +to_string(l) + "Data"
...
// Macros to build attribute names
#define CACAttributeNameCode(l) string(CACAttributeName)+"L" + to_string(l) + "Code"
#define CACAttributeNameData(l) string(CACAttributeName)+"L" + to_string(l) + "Data"
...
#define AGEMustAttributeNameCode(l) string(AGEAttributeName)+"L"+to_string(l) + "Code_MUST"

#define AGEPSAttributeNameCode(l) string(AGEAttributeName)+"L"+to_string(l) + "Code_PS"
...
#define BlockCountAttributeName(l) string(DataAccessedBlockCountAttributeName)+"L"+to_string(l)
...
/** Branch prediction attribute
 * ---------------------
 *
 */
#define BRPRED_LOOP_NBMISSBTB "Loop_NB_MissBTB"
#define BRPRED_LOOP_NBGOODPRED "Loop_Nb_GoodPrediction"
#define BRPRED_LOOP_NBWRONGPRED "Loop_Nb_WrongPrediction"
