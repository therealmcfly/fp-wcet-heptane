...
namespace cfglib 
{
  ...
  class SerialisableListAttribute : public SerialisableAttribute {
    ...
    class SerialisableDoubleAttribute : public SerialisableAttribute {
  private:
    double value;
  public:
    /*! Constructor */
    SerialisableDoubleAttribute() {};
    SerialisableDoubleAttribute(unsigned long val): value(val){};
    
    /*! default constructor. */
    ~SerialisableDoubleAttribute() {} ;
    
    /*! cloning function */
    SerialisableDoubleAttribute* clone() ;
    ...
    void SetValue(double v) {value =v;};
     ...
     /*! Factory */
    SerialisableDoubleAttribute *create(); 
  } ;
