...
namespace cfglib 
{
  ...
  public:
    ...
    Cfg(Program* program, t_address addr, ListOfString name);
    ...
    /** The CFG is reset as external cfg */
    void becomesExternal();

    /*! retrieve the function name of this Cfg */
    ListOfString GetName() ;
    
    /*! retrieve the address of this cfg.*/
    t_address GetAddress();
