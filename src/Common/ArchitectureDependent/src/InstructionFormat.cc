...
bool Addr::isFormat(const vector < string > &operands)
{
  ...
  bool b = Utl::isAddr(operands[0]);
  // if (!b) cout << " operands[0] =" << operands[0] << endl;
  return b;
}
...
// mem : memory pattern
//--------------------------------------------
bool mem::isFormat(const vector < string > &operands)
{
  if (operands.size() != 1)
    {
      return false;
    }
  if (Arch::isMemPattern(operands[0]) == false)
    {
      return false;
    }
  return true;
...
vector < string > mem::getResourceInputs(const vector < string > &operands)
{
  vector < string > result = Arch::extractInputRegistersFromMem(operands[0]);
...
vector < string > mem::getResourceOutputs(const vector < string > &operands)
{
  vector < string > result;
  assert(result.empty());
  return result;
...
// Int : integer value 
//--------------------------------------------
bool Int::isFormat(const vector < string > &operands)
{
  if (operands.size() != 1)
    {
      return false;
    }
  return Utl::isDecNumber(operands[0]);
}

vector < string > Int::getResourceInputs(const vector < string > &operands)
{
  vector < string > result;
  assert(result.empty());
  return result;
...
vector < string > Int::getResourceOutputs(const vector < string > &operands)
{
  vector < string > result;
  assert(result.empty());
  return result;
...
bool rd_int::isFormat(const vector < string > &operands)
{
  ...
  if (!Arch::isRegisterName(operands[0]))
    {
      return false;
    }
  if (!Utl::isDecNumber(operands[1]))
    {
      return false;
    }
  return true;
...
//----------------------------------------------------
// rs_fp : register source / floating point value
//----------------------------------------------------
bool rs_fp::isFormat(const vector < string > &operands)
{
  if (operands.size() != 2)
    return false;
  if (!Arch::isRegisterName(operands[0]))
    return false;
  if (!Utl::isFPNumber(operands[1]))
    return false;
  return true;
}

vector < string > rs_fp::getResourceInputs(const vector < string > &operands)
{
  vector < string > result;
  assert(result.empty());
  return result;
...
vector < string > rs_fp::getResourceOutputs(const vector < string > &operands)
{
  vector < string > result;
  result.push_back(operands[0]);
  return result;
...
bool rs_addr::isFormat(const vector < string > &operands)
{
  ...
  if (! Arch::isRegisterName(operands[0])) return false;
  if (! Utl::isAddr(operands[1])) return false;
  return true;
}
...
//--------------------------------------------
// hex_rs : integer value in hexa (0x...) / register destination 
//--------------------------------------------
bool hex_rs::isFormat(const vector < string > &operands)
{
  if (operands.size() != 2)
    {
      return false;
...
vector < string > hex_rs::getResourceInputs(const vector < string > &operands)
{
  vector < string > result;
  assert(result.empty());
  return result;
...
vector < string > hex_rs::getResourceOutputs(const vector < string > &operands)
{
  vector < string > result;
...
//      int_rs
//--------------------------------------------
bool int_rs::isFormat(const vector < string > &operands)
{
  if (operands.size() != 2)
    {
      return false;
    }
  if (Utl::isDecNumber(operands[0]) == false)
    {
      return false;
    }
  if (Arch::isRegisterName(operands[1]) == false)
...
vector < string > int_rs::getResourceInputs(const vector < string > &operands)
{
  vector < string > result;
...
vector < string > int_rs::getResourceOutputs(const vector < string > &operands)
{
  vector < string > result;
  assert(result.empty());
  return result;
...
//--------------------------------------------
// mem_rd : register destination / memory pattern
//--------------------------------------------
bool mem_rd::isFormat(const vector < string > &operands)
{
  if (operands.size() != 2) return false;
  if ( ! Arch::isRegisterName(operands[1])) return false;
  if ( ! Arch::isMemPattern(operands[0])) return false;
  return true;
}

vector < string > mem_rd::getResourceInputs(const vector < string > &operands)
{
  vector < string > result = Arch::extractInputRegistersFromMem(operands[0]);
  result.push_back("mem");
  return result;
...
vector < string > mem_rd::getResourceOutputs(const vector < string > &operands)
{
  vector < string > result = Arch::extractOutputRegistersFromMem(operands[0]);
  result.push_back(operands[1]);
  return result;
}

//--------------------------------------------
// hex_mem : integer value in hexa (0x...) / memory pattern
//--------------------------------------------
bool hex_mem::isFormat(const vector < string > &operands)
{
  if (operands.size() != 2)
    {
      return false;
    }
  if (Utl::isHexNumber(operands[0]) == false)
    {
      return false;
    }
  if (Arch::isMemPattern(operands[1]) == false)
...
vector < string > hex_mem::getResourceInputs(const vector < string > &operands)
{
  vector < string > result;
  assert(result.empty());
  return result;
...
vector < string > hex_mem::getResourceOutputs(const vector < string > &operands)
{
  vector < string > result = Arch::extractOutputRegistersFromMem(operands[1]);
...
//--------------------------------------------
// hex_rd : register destination / integer value in hexa (0x...)
//--------------------------------------------
bool hex_rd::isFormat(const vector < string > &operands)
{
  if (operands.size() != 2)
    {
      return false;
...
vector < string > hex_rd::getResourceInputs(const vector < string > &operands)
{
  vector < string > result;
  assert(result.empty());
  return result;
...
vector < string > hex_rd::getResourceOutputs(const vector < string > &operands)
{
  vector < string > result;
...
//--------------------------------------------
// int_mem : integer value / memory pattern
//--------------------------------------------
bool int_mem::isFormat(const vector < string > &operands)
{
  if (operands.size() != 2) return false;
  if (Utl::isDecNumber(operands[0]) == false) return false;
  if (Arch::isMemPattern(operands[1]) == false) return false;
  return true;
}

vector < string > int_mem::getResourceInputs(const vector < string > &operands)
{
  vector < string > result;
  assert(result.empty());
  return result;
...
vector < string > int_mem::getResourceOutputs(const vector < string > &operands)
{
  vector < string > result = Arch::extractOutputRegistersFromMem(operands[1]);
...
//--------------------------------------------
// mem_mem : register source / memory pattern
//--------------------------------------------
bool mem_mem::isFormat(const vector < string > &operands)
{
  if (operands.size() != 2)
    {
      return false;
...
vector < string > mem_mem::getResourceInputs(const vector < string > &operands)
{
  vector < string > result = Arch::extractInputRegistersFromMem(operands[0]);
...
vector < string > mem_mem::getResourceOutputs(const vector < string > &operands)
{
  vector < string > result = Arch::extractOutputRegistersFromMem(operands[0]);
...
//--------------------------------------------
// int_addr : register source / integer value corresponding to an address
//--------------------------------------------
bool int_addr::isFormat(const vector < string > &operands)
{
  if (operands.size() != 2)
    {
      return false;
...
vector < string > int_addr::getResourceInputs(const vector < string > &operands)
{
  vector < string > result;
  assert(result.empty());
  return result;
...
vector < string > int_addr::getResourceOutputs(const vector < string > &operands)
{
  vector < string > result;
  assert(result.empty());
  return result;
...
//--------------------------------------------
// addr_mem : integer value corresponding to an address / memory pattern
//--------------------------------------------
bool addr_mem::isFormat(const vector < string > &operands)
{
  if (operands.size() != 2)
    {
      return false;
    }
  if (Utl::isAddr(operands[0]) == false)
    {
      return false;
    }
  if (Arch::isMemPattern(operands[1]) == false)
...
vector < string > addr_mem::getResourceInputs(const vector < string > &operands)
{
  vector < string > result;
  assert(result.empty());
  return result;
...
vector < string > addr_mem::getResourceOutputs(const vector < string > &operands)
{
  vector < string > result = Arch::extractOutputRegistersFromMem(operands[1]);
...
//--------------------------------------------
// addr_rd : integer value corresponding to an address / register destination 
//--------------------------------------------
bool addr_rd::isFormat(const vector < string > &operands)
{
  if (operands.size() != 2)
    {
      return false;
    }
  if (!Arch::isRegisterName(operands[1]))
    {
      return false;
    }
  if (Utl::isAddr(operands[0]) == false)
...
vector < string > addr_rd::getResourceInputs(const vector < string > &operands)
{
  vector < string > result;
  assert(result.empty());
  return result;
...
vector < string > addr_rd::getResourceOutputs(const vector < string > &operands)
{
  vector < string > result;
  result.push_back(operands[1]);
  return result;
...
//--------------------------------------------
// mem_addr : memory pattern / integer value corresponding to an address 
//--------------------------------------------
bool mem_addr::isFormat(const vector < string > &operands)
{
  if (operands.size() != 2) return false;
  if (! Utl::isAddr(operands[1])) return false;
  if (! Arch::isMemPattern(operands[0])) return false;
...
vector < string > mem_addr::getResourceInputs(const vector < string > &operands)
{
  vector < string > result = Arch::extractInputRegistersFromMem(operands[0]);
...
vector < string > mem_addr::getResourceOutputs(const vector < string > &operands)
{
  vector < string > result;
  assert(result.empty());
  return result;
...
//--------------------------------------------
//      int_rd integer value / register destination
//--------------------------------------------
bool int_rd::isFormat(const vector < string > &operands)
{
  if (operands.size() != 2) return false;
  if ( ! Utl::isDecNumber(operands[0]) ) return false;
  if ( ! Arch::isRegisterName(operands[1])) return false;
  return true;
}

vector < string > int_rd::getResourceInputs(const vector < string > &operands)
{
  vector < string > result;
  assert(result.empty());
  return result;
...
vector < string > int_rd::getResourceOutputs(const vector < string > &operands)
{
  vector < string > result;
  result.push_back(operands[1]);
  return result;
...
//--------------------------------------------
// addr_addr : integer value corresponding to an address / integer value corresponding to an address
//--------------------------------------------
bool addr_addr::isFormat(const vector < string > &operands)
{
  if (operands.size() != 2) return false;
  if (! Utl::isAddr(operands[0])) return false;
  if (! Utl::isAddr(operands[1])) return false;
  return true;
}

vector < string > addr_addr::getResourceInputs(const vector < string > &operands)
{
  vector < string > result;
  assert(result.empty());
  return result;
...
vector < string > addr_addr::getResourceOutputs(const vector < string > &operands)
{
  vector < string > result;
  assert(result.empty());
  return result;
...
vector < string > rd_addr::getResourceInputs(const vector < string > &operands)
{
  vector < string > result;
...
vector < string > rd_addr::getResourceOutputs(const vector < string > &operands)
{
  vector < string > result;
  assert(result.empty());
  return result;
...
//--------------------------------------------
// rd_addr : target register / integer value corresponding to an address (RISC-V)
//--------------------------------------------
bool rd_addr::isFormat(const vector < string > &operands)
{
  if (operands.size() != 2)
    {
      return false;
...
//--------------------------------------------
// rd_rs_rounding : register source / register source
//--------------------------------------------
rd_rs_rounding::rd_rs_rounding(const string & out)
{
  rout = out;
}

bool rd_rs_rounding::isFormat(const vector < string > &operands)
{
  if (operands.size() != 3) return false;
  if (!Arch::isRegisterName(operands[0])) return false;
  if (!Arch::isRegisterName(operands[1])) return false;
  //  cout << ">>> WARNING: The third argument " << operands[2] << " is currently ignored " << endl; 
  return true;
}

vector < string > rd_rs_rounding::getResourceInputs(const vector < string > &operands)
{
  vector < string > result;
  result.push_back(operands[1]);
  return result;
...
vector < string > rd_rs_rounding::getResourceOutputs(const vector < string > &operands)
{
  vector < string > result;
  result.push_back(operands[0]);
  // Ignoring the rounding parameter (third operand element of "rne,rtz,rdn,rup,rmm,dyn")
  return result;
}


bool int_instr::isFormat(const vector < string > &operands)
{
  if ( operands.size() != 2)  return false;
  if (! Utl::isDecNumber(operands[0]) ) return false;
  return true;
...
vector < string > int_instr::getResourceInputs(const vector < string > &operands)
{
  return operands;
}

vector < string > int_instr::getResourceOutputs(const vector < string > &operands)
{
  vector < string > result;
  assert(result.empty());
  return result;
