...
class InstructionType
{
    ...
    /*! Returns true if the instruction is a repeat instruction (MSP430) */
...
// Repeat instructions
//---------------------------------------------
class Repeat : public InstructionType
{
    public :
    Repeat(const string& fu,const set<InstructionFormat*>& f, DAAInstruction* daainstr, int lat);
    bool isRepeat();
};
