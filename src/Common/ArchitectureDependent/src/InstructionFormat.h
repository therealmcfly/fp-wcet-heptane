...
/*****************************************************************
    ...
    like MIPS.cc/ARMS.cc for the formats map
 
    Semantic of the notation:
        rd:     register destination
        rs:     register source
	rds:	register source and destination
        mem:    memory pattern -> (for mips/msp430 : offset (base)) (for arm: [*******])
...
//      mem
//--------------------------------------------
class mem:public InstructionFormat {
 public:
  bool isFormat(const vector < string > &operands);
   vector < string > getResourceInputs(const vector < string > &operands);
   vector < string > getResourceOutputs(const vector < string > &operands);
...
//--------------------------------------------
//      Int (added for MSP430 (ret value)
//--------------------------------------------
class Int:public InstructionFormat {
 public:
  bool isFormat(const vector < string > &operands);
   vector < string > getResourceInputs(const vector < string > &operands);
   vector < string > getResourceOutputs(const vector < string > &operands);
...
//      rd_fp
//--------------------------------------------
class rs_fp:public InstructionFormat {
 public:
  bool isFormat(const vector < string > &operands);
   vector < string > getResourceInputs(const vector < string > &operands);
   vector < string > getResourceOutputs(const vector < string > &operands);
...
//      hex_rs
//--------------------------------------------
class hex_rs:public InstructionFormat {
 public:
  bool isFormat(const vector < string > &operands);
   vector < string > getResourceInputs(const vector < string > &operands);
   vector < string > getResourceOutputs(const vector < string > &operands);
...
//      int_rs
//--------------------------------------------
class int_rs:public InstructionFormat {
 public:
  bool isFormat(const vector < string > &operands);
   vector < string > getResourceInputs(const vector < string > &operands);
   vector < string > getResourceOutputs(const vector < string > &operands);
...
//      mem_rd
//--------------------------------------------
class mem_rd:public InstructionFormat {
 public:
  bool isFormat(const vector < string > &operands);
   vector < string > getResourceInputs(const vector < string > &operands);
   vector < string > getResourceOutputs(const vector < string > &operands);
...
//      hex_mem
//--------------------------------------------
class hex_mem:public InstructionFormat {
 public:
  bool isFormat(const vector < string > &operands);
   vector < string > getResourceInputs(const vector < string > &operands);
   vector < string > getResourceOutputs(const vector < string > &operands);
...
//      hex_rd
//--------------------------------------------
class hex_rd:public InstructionFormat {
 public:
  bool isFormat(const vector < string > &operands);
   vector < string > getResourceInputs(const vector < string > &operands);
   vector < string > getResourceOutputs(const vector < string > &operands);
...
//      int_mem
//--------------------------------------------
class int_mem:public InstructionFormat {
 public:
  bool isFormat(const vector < string > &operands);
   vector < string > getResourceInputs(const vector < string > &operands);
   vector < string > getResourceOutputs(const vector < string > &operands);
...
//      mem_mem
//--------------------------------------------
class mem_mem:public InstructionFormat {
 public:
  bool isFormat(const vector < string > &operands);
   vector < string > getResourceInputs(const vector < string > &operands);
   vector < string > getResourceOutputs(const vector < string > &operands);
...
//      int_addr
//--------------------------------------------
class int_addr:public InstructionFormat {
 public:
  bool isFormat(const vector < string > &operands);
   vector < string > getResourceInputs(const vector < string > &operands);
   vector < string > getResourceOutputs(const vector < string > &operands);
...
//      addr_mem
//--------------------------------------------
class addr_mem:public InstructionFormat {
 public:
  bool isFormat(const vector < string > &operands);
   vector < string > getResourceInputs(const vector < string > &operands);
   vector < string > getResourceOutputs(const vector < string > &operands);
...
//      addr_rd
//--------------------------------------------
class addr_rd:public InstructionFormat {
 public:
  bool isFormat(const vector < string > &operands);
   vector < string > getResourceInputs(const vector < string > &operands);
   vector < string > getResourceOutputs(const vector < string > &operands);
...
//      mem_addr
//--------------------------------------------
class mem_addr:public InstructionFormat {
 public:
  bool isFormat(const vector < string > &operands);
   vector < string > getResourceInputs(const vector < string > &operands);
   vector < string > getResourceOutputs(const vector < string > &operands);
...
//      int_rd
//--------------------------------------------
class int_rd:public InstructionFormat {
 public:
  bool isFormat(const vector < string > &operands);
   vector < string > getResourceInputs(const vector < string > &operands);
   vector < string > getResourceOutputs(const vector < string > &operands);
...
//      addr_addr
//--------------------------------------------
class addr_addr:public InstructionFormat {
 public:
  bool isFormat(const vector < string > &operands);
   vector < string > getResourceInputs(const vector < string > &operands);
   vector < string > getResourceOutputs(const vector < string > &operands);
...
//--------------------------------------------
//      rd_addr  RISC-V  to be updated
//--------------------------------------------
class rd_addr:public InstructionFormat {
 public:
  bool isFormat(const vector < string > &operands);
   vector < string > getResourceInputs(const vector < string > &operands);
   vector < string > getResourceOutputs(const vector < string > &operands);
...
//--------------------------------------------
//      rd_rs_rounding  RISC-V to be updated
//--------------------------------------------
class rd_rs_rounding:public InstructionFormat {
 private:
  string rout;
 public:
  rd_rs_rounding(const string & out);
  bool isFormat(const vector < string > &operands);
   vector < string > getResourceInputs(const vector < string > &operands);
   vector < string > getResourceOutputs(const vector < string > &operands);
};
...
//      int_rs
//--------------------------------------------
class int_instr:public InstructionFormat {
 public:
  bool isFormat(const vector < string > &operands);
  vector < string > getResourceInputs(const vector < string > &operands);
  vector < string > getResourceOutputs(const vector < string > &operands);
