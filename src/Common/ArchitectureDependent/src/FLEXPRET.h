...
/*****************************************************************
		...
		FLEXPRET architecture definition (RISC-V ISA compatible)

 *****************************************************************/

#ifndef ARCH_FLEXPRET
#define ARCH_FLEXPRET
...
public:
	/*!constructor*/
	FLEXPRET(const bool is_big_endian_p, const string &dataPath);
