...
public :
    ...
    static void init(const string& arch, const bool is_big_endian, const string &dataPath );
    ...
    static bool isRepeat(const ObjdumpInstruction& instr);
    ...
    static string rebuiltObjdumpInstruction(const string & vcode, t_address addrinstr);
    ...
    static int getSizeOfMemoryAccess(const string& instr);
     ...
     static uint32_t getStackFrameReservedSize(const string &instr);
    ...
    static int getPipelineFlushCost();
    static int getBranchPredWrongPredCost(uint32_t memlatency, const string &code);
    static int getBranchPredCorrectPredGain(uint32_t memlatency, const string &code);
    static int getBranchPredMissBTBCost(uint32_t memlatency, const string &code);
...
public:
  ...
  /*! Returns true if instr is a repeat instruction (MSP430) */
  bool isRepeat(const ObjdumpInstruction& instr);  
  ...
  virtual string rebuiltObjdumpInstruction(const string & vcode, t_address addrinstr)=0;
  ...
  ********************************************************************/
  ...
  virtual uint32_t getStackFrameReservedSize(const string &instr) {assert(false && "Not defined for this architecture");return 0;}
  ...
  virtual int getPipelineFlushCost() = 0;
  
  virtual int getBranchPredWrongPredCost(uint32_t, const string &) {return 0;}
  virtual int getBranchPredCorrectPredGain(uint32_t, const string &) {return 0;}
  virtual int getBranchPredMissBTBCost(uint32_t memlatency, const string &code) {return 0;}
