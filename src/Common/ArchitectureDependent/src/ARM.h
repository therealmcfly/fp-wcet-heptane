...
#define ARM_LR_REGISTER  14
#define ARM_PC_REGISTER  15

#define ARM_AUX_REGISTER 91
#define ARM_NB_REGISTERS 92 /* Using an auxiliary register (ARM_AUX_REGISTER) */
...
public:
  ...
  ARM(const bool is_big_endian_p, const string &dataPath);
    /*!destructor*/
    ~ARM();
    ...
    uint32_t getStackFrameReservedSize(const string &instr) {return 0;};
